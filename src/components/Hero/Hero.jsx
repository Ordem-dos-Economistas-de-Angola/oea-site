      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(100deg, rgba(10,10,10,0.97) 0%, rgba(10,10,10,0.88) 45%, rgba(10,10,10,0.55) 100%)",
          }}
        />
      </div>
      ...
      <div className="hero-inner">
        <div className="hero-content">
          ...
          <p className="hero-desc">
            A Ordem dos Economistas de Angola é a instituição de utilidade
            pública que regula, valoriza e representa os profissionais de
          ...
          <div className="hero-stats">
            <div>
              ...
              <div className="hero-stat-value" data-count="1921">
                1.921<span>+</span>
              </div>
            </div>
            <div>
              <div className="hero-stat-label">Delegações</div>
              <div className="hero-stat-value" data-count="4">
                4<span></span>
              </div>
            </div>
            <div>
              <div className="hero-stat-label">Anos de Actividade</div>
              <div className="hero-stat-value" data-count="15">
                15<span>+</span>
              </div>
            </div>
          </div>
          ...
          <div className="hero-photo-frame">
            ...
            <div className="hero-photo-fallback" style={{ display: "none" }}>
              <div style={{ fontSize: 80, opacity: 0.3 }}>
                <Icon name="suit" size={60} />
              </div>
              <div style={{ color: "rgba(255,255,255,0.4)", fontSize: 14 }}>
                Economista Profissional
              </div>
            </div>
            ...
            <div className="hero-photo-caption">
              <div className="hero-photo-caption-inner">
                ...
                >
                  Profissionais que movem
                  <br />a economia nacional
                </div>
              </div>
