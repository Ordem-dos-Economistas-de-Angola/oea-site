...
const STEPS = [
  {
    n: 1,
    title: "Verifique os Requisitos",
    desc: "Licenciatura, mestrado ou doutoramento em Economia, Gestão, Finanças, Planeamento ou áreas afins, obtido em Angola ou no estrangeiro.",
  },
  {
    n: 2,
    title: "Reúna a Documentação",
    desc: "Certidão de habilitações, bilhete de identidade/passaporte, fotografia actualizada, curriculum vitae e comprovativo de pagamento da jóia.",
  },
  {
    n: 3,
    title: "Submeta a Candidatura",
    desc: "Preencha o formulário online ou entregue o processo completo na sede da OEA.",
  },
  {
    n: 4,
    title: "Aguarde Aprovação",
    desc: "A Comissão de Admissões analisa o processo e, após aprovação, emite a cédula profissional e número de membro.",
  },
  {
    n: 5,
    title: "Bem-vindo à OEA!",
    desc: "Aceda a todos os benefícios: formação, eventos, mentoria, representação e a rede de economistas angolanos.",
  },
];
      ...
      <div className="section-inner">
        <div className="section-header center" style={{ marginBottom: 48 }}>
          ...
          <p className="section-desc">
            Junte-se à família dos economistas angolanos e beneficie de todos os
            serviços, representação e reconhecimento da Ordem.
          </p>
        </div>
        ...
        <div className="admissao-grid">
          ...
          <div className="admissao-info reveal-right">
            ...
            >
              <div className="info-card-title" style={{ color: "var(--red)" }}>
                <Icon name="phone" size={20} /> Contacte-nos
              </div>
              <p
                style={{ fontSize: 14, color: "var(--mid)", lineHeight: 1.65 }}
              >
            ...
            >
              <div className="info-card-title" style={{ color: "var(--gold)" }}>
                <Icon name="building" size={20} /> Delegações Regionais
              </div>
              <p
                style={{
                  fontSize: 13,
              ...
              >
                A OEA está presente em 4 regiões do país, com planos de expansão
                para 5 Conselhos Regionais até 2030.
              </p>
