...
import { useAdmissaoPageState } from "./state";
...
export default function AdmissaoPage() {
  const { step, form, submitted, handleChange, nextStep, prevStep, handleSubmit, resetForm } = useAdmissaoPageState();
          ...
          <div className="section-inner">
            <div className="section-header center" style={{ marginBottom: 48 }}>
              ...
              <p className="section-desc">
                A sua candidatura foi submetida com sucesso. A Comissão de
                Admissões irá analisar o seu processo e entrará em contacto
                através do email <strong>{form.email}</strong> nos próximos dias
                úteis.
              </p>
            </div>
            <div style={{ textAlign: "center" }}>
              <div
                style={{ fontSize: 64, marginBottom: 24, color: "var(--red)" }}
              >
              ...
              >
                Enquanto aguarda, pode ir reunindo a documentação necessária.
                Qualquer dúvida, contacte a Secretaria da OEA.
              </p>
              <Link
                to="/"
      ...
      case 2:
        return (
          <>
            ...
            >
              Após a aprovação da sua candidatura, estas credenciais
              permitir-lhe-ão aceder à Área de Membros da OEA.
            </p>
            <div className="form-row form-row-2">
              <FormField
                name="password"
            ...
            <div className="login-social" style={{ marginTop: 8 }}>
              ...
              >
                Ou registe-se com as suas redes sociais
              </p>
              <button
                className="btn login-social-btn"
                type="button"
                onClick={() => {}}
              >
      ...
      case 4:
        return (
          <>
            ...
            >
              Escolha a delegação da OEA à qual pretende ficar vinculado, de
              acordo com a sua área de residência ou exercício profissional.
            </p>
            <div className="form-row">
              <div className="form-group">
                <label className="form-label" htmlFor="delegacao">
                  Delegação *
                </label>
                <select
                  id="delegacao"
                  name="delegacao"
                  value={form.delegacao}
                  onChange={handleChange}
                  className="form-input"
                  required
                >
                ...
                {form.delegacao && (
                  <p
                    style={{ fontSize: 12, color: "var(--mid)", marginTop: 6 }}
                  >
                    {
                      DELEGACOES.find((d) => d.title === form.delegacao)
                        ?.provinces
                    }
                  </p>
                )}
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <textarea
                  ...
                  placeholder="Descreva brevemente a sua experiência profissional na área económica ou financeira..."
                  rows={3}
                />
              </div>
            </div>
            <div className="form-row">
              <div className="form-group">
                <label className="form-label" htmlFor="comoConheceu">
                  Como conheceu a OEA? (opcional)
                </label>
                <select
                  id="comoConheceu"
                  name="comoConheceu"
      ...
      case 5:
        return (
          <>
            ...
            >
              Selecione o método de pagamento para a jóia de inscrição e
              primeira quota.
            </p>

            <div className="payment-methods">
              <label
                className={`payment-method ${form.metodoPagamento === "transferencia" ? "selected" : ""}`}
              >
                <input
                  type="radio"
                  name="metodoPagamento"
                  value="transferencia"
                  checked={form.metodoPagamento === "transferencia"}
                  onChange={handleChange}
                />
                <div>
                  ...
                  <div className="payment-method-desc">
                    Transferência para a conta da OEA no BAI
                  </div>
                </div>
              </label>
              <label
                className={`payment-method ${form.metodoPagamento === "multicaixa" ? "selected" : ""}`}
              >
                <input
                  type="radio"
                  name="metodoPagamento"
                  value="multicaixa"
                  checked={form.metodoPagamento === "multicaixa"}
                  onChange={handleChange}
                />
                <div>
                  <div className="payment-method-label">Multicaixa / ATM</div>
                  <div className="payment-method-desc">
                    Pagamento presencial nos terminais Multicaixa
                  </div>
                </div>
              </label>
              <label
                className={`payment-method ${form.metodoPagamento === "presencial" ? "selected" : ""}`}
              >
                <input
                  type="radio"
                  name="metodoPagamento"
                  value="presencial"
                  checked={form.metodoPagamento === "presencial"}
                  onChange={handleChange}
                />
                <div>
                  <div className="payment-method-label">
                  ...
                  <div className="payment-method-desc">
                    Dirija-se à sede ou delegação da OEA
                  </div>
                </div>
              </label>
            </div>
            ...
            {form.metodoPagamento === "transferencia" && (
              <div>
                ...
                <div className="form-row">
                  <div className="form-group">
                    <label className="form-label" htmlFor="comprovativo">
                      Comprovativo de Transferência (opcional)
                    </label>
                    <input
                      id="comprovativo"
                      name="comprovativo"
                      ...
                      onChange={(e) =>
                        handleChange({
                          target: { name: "comprovativo", value: e.target.files[0] }
                        })
                      }
                      className="form-input"
                      style={{ padding: 10 }}
                    ...
                    >
                      Formatos aceites: JPG, PNG, PDF. Máx. 5 MB.
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <p style={{ fontSize: 12, color: "var(--mid)", lineHeight: 1.6 }}>
                O pagamento da jóia de inscrição é obrigatório para a validação
                da candidatura. Após a aprovação, receberá um email com os
                detalhes para pagamento das quotas subsequentes.
              </p>
            </div>
          </>
        );
      ...
      <section className="section">
        <div className="section-inner">
          ...
          <div className="section-header center" style={{ marginBottom: 48 }}>
            ...
            <p className="section-desc">
              Preencha todos os campos obrigatórios para iniciar o seu processo
              de admissão como membro da Ordem dos Economistas de Angola.
            </p>
          </div>
          ...
          <div className="progress-wrapper">
            ...
            <div className="progress-steps">
              {STEPS.map((s) => (
                <div
                  key={s.num}
                  className={`progress-step ${s.num === step ? "active" : ""} ${s.num < step ? "done" : ""}`}
                >
          ...
          <div className="admissao-grid">
            <form className="admissao-form" onSubmit={handleSubmit}>
              ...
              >
                Ao submeter, declara que as informações fornecidas são
                verdadeiras. Os dados serão tratados de acordo com a Política de
                Privacidade da OEA.
              </p>
            </form>
            ...
            <div>
              <div className="info-card">
                <div className="info-card-title">
                  <Icon name="clipboard" size={20} /> Documentos Necessários
                </div>
              ...
              <div className="info-card">
                <div className="info-card-title">
                  <Icon name="wallet" size={20} /> Taxas e Quotas
                </div>
              ...
              <div
                ...
                style={{
                  ...
                  border: "1px solid rgba(192,24,26,0.15)",
                }}
              >
                <div
                  ...
                  style={{ color: "var(--red)" }}
                >
                  <Icon name="phone" size={20} /> Contacte-nos
                </div>
                <p
                  style={{
                    fontSize: 14,
                ...
                >
                  Para mais informações sobre o processo de admissão, contacte a
                  Secretaria da OEA.
                </p>
                <div
                  style={{
                ...
                >
                  <div style={{ fontSize: 14, color: "var(--dark)" }}>
                    <Icon name="phone" size={14} /> (+244) 937 668 854
                  </div>
                  <div style={{ fontSize: 14, color: "var(--dark)" }}>
