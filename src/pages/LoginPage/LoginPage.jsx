...
export default function LoginPage() {
  const { form, setForm, remember, setRemember, error, loading, handleChange, handleSubmit } = useLoginState();
          ...
          <div className="login-layout">
            <div className="login-card">
              <div className="login-header">
                <div className="section-tag" style={{ justifyContent: 'center' }}>Acesso</div>
                <div className="gold-sep" style={{ margin: '16px auto' }} />
                <h2 className="section-title" style={{ textAlign: 'center' }}>Área de Membros</h2>
                <p className="section-desc" style={{ textAlign: 'center', margin: '0 auto' }}>
                  Entre com o seu email e senha para aceder aos conteúdos exclusivos da OEA.
                </p>
              </div>
              ...
              <div className="login-social">
                <button className="btn login-social-btn">
