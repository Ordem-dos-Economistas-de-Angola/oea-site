...
import { useAdminEventosState } from './state';

export default function AdminEventos() {
  const { eventos, modal, form, search, handleChange, openNew, openEdit, handleSave, handleDelete, setModal, setSearch } = useAdminEventosState();
