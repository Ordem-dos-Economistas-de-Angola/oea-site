...
import { useDelegacaoCentroPageState } from './state';
import '../OrdemPages.css';
import '../DelegacoesPages.css';

const PROVINCIAS = ['Benguela', 'Huambo', 'Bié', 'Cuanza Sul'];
...
export default function DelegacaoCentroPage() {
  useDelegacaoCentroPageState();
      ...
      <section className="section">
        <div className="section-inner">
          ...
          <div className="section-header">
            ...
            <h2 className="section-title">Delegação Regional Centro</h2>
            <p className="section-desc">Abrange 4 províncias do planalto central de Angola, uma região de forte actividade agrícola e industrial.</p>
          </div>

          <div className="delegacao-regions-nav">
            <Link to="/delegacao-norte"><Icon name="city" size={16} /> Norte</Link>
            <Link to="/delegacao-centro" className="active"><Icon name="mountain" size={16} /> Centro</Link>
            ...
            <div className="page-content">
              <div className="reveal">
                <div className="delegacao-header">
                  <h3><Icon name="mountain" size={24} /> Região Centro</h3>
                  <p>A Delegação Regional Centro tem a sua sede em Luanda e abrange as províncias de Benguela, Huambo, Bié e Cuanza-Sul, cobrindo o planalto central de Angola.</p>
                </div>

                <div className="map-container reveal">
                  <iframe
                    title="Mapa Região Centro"
                    src="https://www.openstreetmap.org/export/embed.html?bbox=13.5%2C-14.0%2C17.0%2C-11.0&amp;layer=mapnik"
                    loading="lazy"
                  />
                  <div className="map-overlay"><Icon name="pin" size={14} /> Região Centro de Angola</div>
                </div>
                ...
                <div className="delegacao-stats reveal">
                  ...
                  <div className="delegacao-stat">
                    <div className="stat-val">Centro</div>
            ...
            <div className="page-sidebar">
              <div className="page-sidebar-card">
                ...
                <ul>
                  ...
                  <li><Link to="/delegacao-centro" className="active">Região Centro</Link></li>
              ...
              <div className="page-sidebar-card">
                <h4><Icon name="trophy" size={18} /> Destaque</h4>
                <p style={{ fontSize: 13, color: 'var(--mid)', lineHeight: 1.6 }}>
                  O Huambo, segunda maior cidade de Angola, é um importante centro económico e académico, com forte presença de economistas e instituições de ensino superior.
                </p>
              </div>
            </div>
          </div>
